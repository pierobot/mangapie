...
@section ('navtabs-content')
    <div class="d-block d-sm-none">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item active"><a class="nav-link"><span class="fa fa-folder-open"></span>&nbsp;Files</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ URL::action('MangaController@comments', [$manga]) }}"><span class="fa fa-comment"></span>&nbsp;Comments</a></li>
        </ul>
