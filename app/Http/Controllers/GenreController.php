...
{
    private function populateGenres() {
        // $dom = new Dom;
        // $dom->load('https://www.mangaupdates.com/genres.html');

        // /*
        //     <td class="releasestitle" align="left" width="100%"><b>Action</b></td>
        // */
        // $td_tag = $dom->find('tr td b');
