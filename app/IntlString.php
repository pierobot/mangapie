...
class IntlString {
     ...
     *
     *  @param string $str1 The string to convert.
     *  @param string $encoding The encoding to use.
     *  @return string A string with the specified encoding.
     */
     ...
     *
     *  @param string $str1 The string from which to extract a grapheme.
     *  @param int $offset The starting offset of a grapheme.
     *  @param int $next A reference to a variable that will hold the offset of the next grapheme.
     *  @return string A string that contains the grapheme at the specified offset.
     */
     ...
     *  @return int An integer that indicates lexicographical difference between the two strings.
     ...
     *  @param string $str1 A string.
     *  @param string $str2 A string.
     *  @param int $count The count of grapheme units to compare.
     *  @return int An integer that indicates lexicographical difference between the two strings.
     *          A value of zero indicates they are lexicographically equal.
     *          A negative value indicates $str1 is lexicographically less than $str2.
     *          A positive value indicates $str2 is lexicographically greater than $str2.
